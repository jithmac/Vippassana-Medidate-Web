...
const checkboxClass =
  "w-4 h-4 rounded border-sand text-saffron accent-saffron cursor-pointer";
...
export default function ApplyPage() {
  ...
  const addCourseEntry = () => {
    setCourseHistory([
      ...courseHistory,
      { courseType: "10-day", startDate: "", endDate: "", centerName: "", teacherName: "", completed: false },
    ]);
  };
          ...
          {PAGES.map((p, i) => {
            ...
            return (
              <div key={p.label} className="flex items-center">
                ...
                {i < PAGES.length - 1 && (
                  <div className={`w-6 h-px mx-1 ${i < page ? "bg-saffron" : "bg-sand"}`} />
                )}
              </div>
            );
          })}
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            {page === 1 && (
              <div className="space-y-6">
                <div>
                  <h2 className="font-serif text-xl font-bold text-foreground mb-1 lining-nums">Health & Conduct</h2>
                ...
                <div className="bg-cream-dark/50 rounded-xl p-5">
                  ...
                  <div className="grid sm:grid-cols-2 gap-3 mb-6">
                    {[
                      ...
                      { label: "Other Infectious Diseases", state: hasOtherInfectious, setter: setHasOtherInfectious },
                    ].map((item) => (
                ...
                <div className="bg-saffron/5 rounded-xl p-5 border border-saffron/10">
                  <h3 className="font-serif text-base font-semibold text-foreground mb-3">Declaration of Discipline</h3>
            ...
            {/* PAGE 3 - Course History Table */}
            {page === 2 && (
              <div className="space-y-6">
                <div>
                  <h2 className="font-serif text-xl font-bold text-foreground mb-1 lining-nums">Course History</h2>
                  <p className="text-sm text-warm-gray">Have you attended any meditation programs of Honorable Goenka or his respected disciple? List all Vipassana courses you have attended.</p>
                </div>
                ...
                {courseHistory.length === 0 ? (
                  <div className="text-center py-10 bg-cream-dark/30 rounded-xl border border-dashed border-sand">
                    ...
                    <button
                      ...
                      className="inline-flex items-center gap-2 px-5 py-2 rounded-xl bg-saffron text-cream text-sm font-medium hover:bg-saffron-dark transition-all duration-300"
                    >
                      <Plus size={16} />
                      Add First Course
                    </button>
                    ...
                    {courseHistory.map((entry, i) => (
                      ...
                      >
                        ...
                        <div className="grid sm:grid-cols-2 gap-3 mb-3">
                          <div>
                            <label className="text-xs font-medium text-foreground mb-1 block">Course Type</label>
                            <select
                          ...
                          <div>
                            <label className="text-xs font-medium text-foreground mb-1 block">Center</label>
                            <input
                              type="text"
                        ...
                        <div className="mb-3">
                          <label className="text-xs font-medium text-foreground mb-1 block">Teacher Name</label>
                          <input
                            type="text"
                            value={entry.teacherName || ""}
                            onChange={(e) => updateCourseEntry(i, "teacherName", e.target.value)}
                            className={inputClass}
                        ...
                        <label className="flex items-center gap-2 cursor-pointer">
                          <input
                            ...
                            className={checkboxClass}
                          />
                          <span className="text-sm text-foreground">Completed successfully</span>
                        </label>
                      </motion.div>
                    ))}
                    <button
                      onClick={addCourseEntry}
                      className="inline-flex items-center gap-2 px-4 py-2 rounded-xl border border-dashed border-saffron/40 text-saffron-dark text-sm font-medium hover:bg-saffron/5 transition-all duration-300"
                    >
                      <Plus size={16} />
                      Add Another Course
                    </button>
            ...
            {/* PAGE 4 - Practice History */}
            {page === 3 && (
              <div className="space-y-6">
                <div>
                  <h2 className="font-serif text-xl font-bold text-foreground mb-1 lining-nums">Practice History</h2>
                ...
                <div className="bg-cream-dark/50 rounded-xl p-5">
                  <h3 className="text-sm font-medium text-foreground mb-3">The Five Precepts</h3>
                ...
                <div>
                  ...
                  <div>
                    ...
                    <textarea
                      value={pastMeditationPractices}
                      onChange={(e) => setPastMeditationPractices(e.target.value)}
                      className={inputClass + " resize-none"}
                      rows={3}
                      placeholder="What other meditation practices have you followed?"
                    />
                  </div>

                  <div>
                    <label className={labelClass}>Who referred you to this course?</label>
                    <input
                      type="text"
                      value={referredByPerson}
                      onChange={(e) => setReferredByPerson(e.target.value)}
                      className={inputClass}
            ...
            {page === 4 && (
              <div className="space-y-6">
                <div>
                  <h2 className="font-serif text-xl font-bold text-foreground mb-1 lining-nums">Course Selection & Summary</h2>
                ...
                <div className="bg-saffron/5 rounded-xl p-5 border border-saffron/10">
                  <h3 className="font-serif text-base font-semibold text-foreground mb-3">Final Instructions</h3>
                  <ul className="text-xs text-warm-gray space-y-1 mb-4 ml-4 list-disc">
